...
from model import _Teacher, TeacherOrStudent
...
if __name__ == "__main__":
    ...
    st_id = 3  # student id, start from 0.
    ...
    class_dir = 'pill/'
    dataset_dir = '/home/yuxuan/mvtec_dataset/' + class_dir + 'train/'
    ...
    checkpoint = torch.load(work_dir + '_teacher' +
                            str(patch_size) + '.pth',map_location=device)
    ...
    torch.save(student.state_dict(), work_dir + class_dir +
            'student' + str(patch_size) + '_' + str(st_id) + '_1117_' + '.pth')
